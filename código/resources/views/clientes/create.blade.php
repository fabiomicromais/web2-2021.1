...
<section class="content_container">
  <div class="content_header">
    <a href="{{ url('clientes/index')}}" class="btn_back">
  ...
  <form action="{{ url("clientes/$cliente->id/update") }}" class="form_create" method="POST">
    @csrf
    @method('PUT')
    <div class="form_item">
...
<section class="content_container">
  ...
  <form action="{{ url('clientes/add') }}" class="form_create" method="POST">
    @csrf
    <div class="form_item">
      <label for="nome">Nome</label>
